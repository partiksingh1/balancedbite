    ...
    return (
        <main className="max-w-3xl mx-auto px-6 py-16 text-gray-800">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Application</strong> refers to BeBalanced, the software program provided by the Company.</p>
                </li>
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to BeBalanced.</p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: partiksingh28@gmail.com</li>
            </ul>
        </main>
    );
}
